        ...
        swimmersGlobalContainer.classList.add('swimmers-global-container')
            ...
            leftSwimmerSideContainer.classList.add('left-swimmer-side-container')
                ...
                swimmerContainer1.classList.add('swimmer-container')
                    ...
                    iconFlag1.src = `../Front-End/assets/flag-icons-main/flags/4x3/${partida.athletes_involved[0].country.toLowerCase()}.svg`
                ...
                swimmerContainer2.classList.add('swimmer-container')
                    ...
                    iconFlag2.src = `../Front-End/assets/flag-icons-main/flags/4x3/${partida.athletes_involved[1].country.toLowerCase()}.svg`
                ...
                swimmerContainer3.classList.add('swimmer-container')
                    ...
                    iconFlag3.src = `../Front-End/assets/flag-icons-main/flags/4x3/${partida.athletes_involved[2].country.toLowerCase()}.svg`
                ...
                swimmerContainer4.classList.add('swimmer-container')
                    ...
                    iconFlag4.src = `../Front-End/assets/flag-icons-main/flags/4x3/${partida.athletes_involved[3].country.toLowerCase()}.svg`
            ...
            rightSwimmerSideContainer.classList.add('right-swimmer-side-container')
                ...
                swimmerContainer5.classList.add('swimmer-container')
                    ...
                    iconFlag5.src = `../Front-End/assets/flag-icons-main/flags/4x3/${partida.athletes_involved[4].country.toLowerCase()}.svg`
                ...
                swimmerContainer6.classList.add('swimmer-container')
                    ...
                    iconFlag6.src = `../Front-End/assets/flag-icons-main/flags/4x3/${partida.athletes_involved[5].country.toLowerCase()}.svg`
                ...
                swimmerContainer7.classList.add('swimmer-container')
                    ...
                    iconFlag7.src = `../Front-End/assets/flag-icons-main/flags/4x3/${partida.athletes_involved[6].country.toLowerCase()}.svg`
                ...
                swimmerContainer8.classList.add('swimmer-container')
                    ...
                    iconFlag8.src = `../Front-End/assets/flag-icons-main/flags/4x3/${partida.athletes_involved[7].country.toLowerCase()}.svg`
